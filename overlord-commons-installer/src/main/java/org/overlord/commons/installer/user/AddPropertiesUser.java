...
public class AddPropertiesUser {
    ...
    protected AddPropertiesUser(ConsoleWrapper console) {
        ...
        if (JBOSS_HOME != null && !JBOSS_HOME.equals("")) {
            stateValues.setJBossHome(JBOSS_HOME);
        } else {
    ...
    protected void run() {
        while ((nextState = nextState.execute()) != null) {
            if (nextState instanceof ErrorState) {
                ErrorState error = (ErrorState) nextState;
                error.execute();
            ...
            while (it.hasNext()) {
                ...
                if (CommandLineArgument.DOMAIN_CONFIG_DIR_USERS.match(temp)) {
                    ...
                    if (commandLineArgument != null) {
                        ...
                        if(commandLineArgument.equals(CommandLineArgument.JBOSS_HOME) && value!=null){
                            JBOSS_HOME = value;
                        }
                        else if (value != null) {
